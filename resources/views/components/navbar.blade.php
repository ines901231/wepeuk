<nav class="flex-no-wrap fixed top-0 z-50 flex w-full items-center justify-between py-2 shadow-md shadow-black/5 dark:shadow-black/10 lg:flex-wrap lg:justify-start lg:py-4 bg-gray-800" x-data="{ isOpen: false }">
